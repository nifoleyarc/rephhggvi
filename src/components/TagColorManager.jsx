      ...
      >
        ...
        <div className="p-4 border-t border-gray-800 bg-gray-800/50">
          <p className="text-sm text-gray-400">
            💡 <strong>Совет:</strong> Изменения сохраняются автоматически. 
            Цвета поддерживают как обычные цвета, так и градиенты. 
            Предустановленные цвета флагов стран уже настроены.
          </p>
        </div>
      </motion.div>
    </div>
