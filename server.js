...
app.use(cookieParser(process.env.IMAGE_UPLOAD_SESSION_SECRET || 'upload-session-secret'))
app.use('/nikothan-favicon', express.static(path.join(__dirname, 'public', 'nikothan-favicon')))
